...
boutonVar4.addEventListener('click', function() {
    p1.innerHTML = '<br><br><br><br>Sa principale caractéristique est sa portée : elle est limité à celle du bloc courant. Pour rappel, un bloc en Javascript, c’est ce qu’on retrouve entre accolades : une comparaison en if, une boucle while etc… Comme c’est une variable, on peut modifier sa valeur après sa déclaration.';
});
